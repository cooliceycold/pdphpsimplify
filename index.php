...
<body>
	...
	<nav class="navbar navbar-expand-sm touming navbar-dark mikup">
		<div class="container">
			<a class="navbar-brand" href="./"><img src="./logo.png" class="img-fluid rounded logo-img mr-2" alt="LOGO" /> PanDownload</a>
