	...
	<div class="container">
		<nav>
			<ol class="breadcrumb my-4">
				<li class="breadcrumb-item"><a href="./">PanDownload</a></li>
		...
		if (file_exists('config.php') and !$is_login) { ?>
			...
			<div class="col-lg-6 col-md-9 mx-auto mb-5 input-card">
				<div class="card">
					<div class="card-header bg-dark text-light">PanDownload- 管理员登录</div>
					<div class="card-body">
				...
				<div class="card-body">
					<form action="install.php" method="post" id="SettingForm">
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input class="form-control" value="PanDownload" name="Sitename" value="<?php echo $Sitename; ?>">
